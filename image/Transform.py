...
class Transform(Image):
    ...
    def to_ascii(self, new_image_name: str = 'new', path: str = 'img/ascii') -> None:
        ...
        new_img = PilImg.open(f'{path}/{new_image_name}.png')
        ...
        for y in range(0, size[1]):
            for x in range(0, size[0]):
                ...
                # add character
                if pixel in pixel_color and pixel != 0:
